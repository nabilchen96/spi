        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data Evaluasi dan Monitoring</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_berkas" id="nama_berkas" class="form-control form-control-sm"
                                placeholder="Nama Berkas" required>
                        </div>
                        <div class="form-group">
                            <label>File Berkas</label>
                            <input type="file" name="file_berkas" id="file_berkas" class="form-control form-control-sm"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control form-control-sm">
                                <option>Sudah Dievaluasi</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer p-3">
    ...
    <script>
        ...
        function getData() {
            $("#myTable").DataTable({
                ...
                columns: [{
                    ...
                    {
                        render: function(data, type, row, meta) {
                            return `<span class="badge bg-info text-white">${row.status}</span>`
                        }
                    },
                    {
                        render: function(data, type, row, meta) {
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#nama_berkas').val(cokData[0].nama_berkas)
            }
        })
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-berkas-review' : '/update-berkas-review',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
        ...
        hapusData = (id) => {
            Swal.fire({
                ...
                if (result.value) {
                    axios.post('/delete-berkas-audit', {
                            id
                        })
                        .then((response) => {
